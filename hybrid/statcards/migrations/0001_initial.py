    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('r05', models.CharField(blank=True, max_length=10, null=True, verbose_name='№ заявления')),
                ('r05_data', models.DateField(blank=True, null=True, verbose_name='Дата регистрации заявления')),
                ('r05_delo_nomer', models.CharField(blank=True, max_length=20, null=True, verbose_name='Дело №...')),
                ('r05_delo_post', models.CharField(blank=True, max_length=100, null=True, verbose_name='поступило из...')),
                ('r05_delo_podsled', models.CharField(blank=True, max_length=500, null=True, verbose_name='по подследственности из...')),
